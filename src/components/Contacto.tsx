...
export default function Contacto() {
  ...
  return (
    <section id="contacto" ref={ref} className="section bg-[#060610] py-20 md:py-40 overflow-hidden">
      {/* Añadimos un extra de padding horizontal en móvil (px-4) para evitar que el texto toque los bordes */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
          ...
          >
            ...
            {/* Ajustamos el leading a 0.9 o 1 en móvil para que no se corten las ascendentes/descendentes de las letras */}
            ...
            {/* Social proof Table - Ajuste de padding interno para móvil */}
            <div className="p-5 md:p-6 border border-white/5 bg-white/[0.02] rounded-2xl backdrop-blur-sm">
              ...
              {[
                { loc: 'Fisioterapia · Madrid',      val: '14h libres' },
                { loc: 'Clínica dental · Sevilla',   val: '−42% no-shows' },
                { loc: 'Medicina Estética · BCN',    val: '+22 sesiones' },
                { loc: 'Psicología · Bilbao',        val: '4.9 ⭐' },
              ].map((s, i) => (
            ...
            <div className="relative card p-6 md:p-12 border border-white/10 bg-[#0A0A15] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/40 font-medium mb-8 leading-relaxed text-xs md:text-base">
                  ...
                  y qué flujos tienen más impacto en tu clínica.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  >
                    Solicitar diagnóstico <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                  </a>

                  <div className="flex flex-col items-center gap-3">
                    <div className="flex items-center gap-2 opacity-40">
                      <Shield size={12} className="text-[#B8FF2E]" />
                      <span className="mono text-[8px] md:text-[10px] uppercase tracking-widest text-white text-center">Sesión gratuita · Sin compromiso</span>
                    </div>
                  </div>
                </div>
              </div>
